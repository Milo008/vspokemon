...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				case 'new-game'|'powersurge'|'accumulate'|'slick':
				    curStage = 'pikachust1';
				case 'voltackle'|'long-body':
					curStage = 'pikachust2';
				case 'walked':
					curStage = 'nightmare';
				default:
		...
		{
			case 'pikachust1':
				var bg:BGSprite = new BGSprite('bg1', -600, -200, 0.9, 0.9);
				add(bg);

			case 'pikachust2':
				var bg:BGSprite = new BGSprite('bg2', -600, -200, 0.9, 0.9);
				add(bg);

			case 'nightmare':
				var bg:BGSprite = new BGSprite('bgwalked', -600, -200, 0.9, 0.9);
				add(bg);
